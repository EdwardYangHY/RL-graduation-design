...
class sarsa_agent(object):
    ...
    def learning(self,pro_fine,lambda_,gamma,alpha,max_episode_num):
        ...
        for num_episode in range(max_episode_num):
            ...
            pos_0=self.pos
            pos_1=self.policy(str(state_0), num_episode, max_episode_num, use_epsilon=True)
            ...
            for i in range(10):
                ...
                if is_done:
                    if num_episode/max_episode_num > 0.9:
                        print("总奖励:{:.2f}".format(total_reward))
                    break
                ...
                pos_2=self.policy(str(state_1), num_episode, max_episode_num, use_epsilon=True) #下一个动作A'
