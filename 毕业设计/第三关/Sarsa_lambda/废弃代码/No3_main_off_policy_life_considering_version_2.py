...
class sarsa_agent(object):
    ...
    def learning_2(self,pro_fine,lambda_,gamma,alpha,max_episode_num,Q=None,epsilon=None):
        if Q is not None:
            self.Q=Q
            self.E_copy_Q()
        else:
    ...
    def reload_training(self,Q_np_name,times):
        ...
        with open(Q_np_name, 'rb') as file:
            Q=pickle.load(file)
        out=self.learning_2(pro_fine=0.6,
                       lambda_=0.01,
                       gamma=0.8,
                       alpha=0.1,
...
a=sarsa_agent(Map)
#Q=a.reload_training('Random_life_saving_100w_version_2.pickle', 100)
...
file = open('Random_life_saving_200w_version_2.pickle', 'wb')
pickle.dump(Q, file)
file.close()

#a.reload('Random_life_saving_100w_version_2.pickle')
