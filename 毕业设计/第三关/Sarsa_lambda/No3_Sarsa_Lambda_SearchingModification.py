...
class sarsa_agent(object):
    ...
    def learning(self,lambda_,gamma,alpha,max_episode_num):
        ...
        return self.Q,return_list
    
    def learning_2(self,lambda_,gamma,alpha,max_episode_num):
        self.Q={}
        self.E={}
        self._init_agent()
        time_start=time.time()
...
Q,return_list=a.learning(lambda_=0.1,
           gamma=0.8,
           alpha=0.01,
           max_episode_num=15000000)
...
file = open('NO3_1500w_negetive_alpha_10-2.pickle', 'wb')
pickle.dump(Q, file)
file.close()

file = open('NO3_1500w_negetive_alpha_10-2_return_list.pickle', 'wb')
