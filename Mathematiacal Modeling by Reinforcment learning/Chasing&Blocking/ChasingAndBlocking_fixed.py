# -*- coding: utf-8 -*-
"""
Created on Fri Apr  9 16:38:59 2021
...
class chess_agent(object):
    ...
    def get_reward(self):
        ...
        reward=0
        rand_1=(self.pos_thief[0]-self.pos_police_1[0])**2+(self.pos_thief[1]-self.pos_police_1[1])**2
        rand_2=(self.pos_thief[0]-self.pos_police_2[0])**2+(self.pos_thief[1]-self.pos_police_2[1])**2
        if rand_1==1 and rand_2==1:
            reward+=0.3
    ...
    def learning(self,lambda_,gamma,alpha,max_episode_num,eval_iteration=10000):
        self.Q={}
        ...
        for num_episode in range(max_episode_num):
            if (num_episode % eval_iteration == 0 and num_episode!=0) or num_episode==max_episode_num-1:
                ...
                head='ChasingAndBlocking_Q-learning'
                ...
                file.close()
                success_rate=self.evaluating(1000)
...
Q=a.learning(lambda_=0.1, gamma=0.8, alpha=0.01, max_episode_num=training_times)
